...
export const TopBar = () => {
    return (
        <Link href="/home" className="absolute z-50 max-w-2xl w-auto h-[70px] flex justify-start items-center px-10 bg-transparent">
            <div className="flex gap-4 items-center bg-transparent">
                <svg width="32" height="32" viewBox="0 0 280 280" fill="none" xmlns="http://www.w3.org/2000/svg">
